...
return [
    ...
    [
        'name' => 'Ice Cream',
        'img' => 'ice_cream',
        'description'=> 'Il gelato è un dessert cremoso e rinfrescante, preparato con latte, zucchero e aromi naturali, offrendo una varietà di gusti come cioccolato, fragola e vaniglia, servito freddo per una piacevole esperienza gustativa.',
    ],
    [
        'name' => 'Fast Food',
        'img' => 'fast_food',
    ...
    [
        ...
        'img' => 'burgers',
        'description'=> '
        L hamburger è un iconico piatto della cucina veloce, composto da un gustoso pattino di carne in un morbido panino, arricchito con condimenti come lattuga, pomodoro, formaggio e salse, offrendo un esperienza gustativa ricca e appagante.',
    ],
    [
        'name' => 'Fish',
        'img' => 'fish',
        'description'=> '
        La cucina di pesce si caratterizza per la freschezza e delicatezza dei sapori marini, con piatti che esaltano varietà come tonno, salmone e merluzzo, accompagnati da salse leggere a base di limone o erbe aromatiche, offrendo un esperienza culinaria leggera e raffinata.',
    ],
    [
        'name' => 'Kebab',
        'img' => 'kebab',
        'description'=> '
        Il kebab è un piatto della cucina mediorientale composto da carne, spesso agnello o pollo, marinata e cotta verticalmente su uno spiedo rotante, servita in un panino o con contorni come insalata e salse, offrendo un mix saporito e aromatico di carne e condimenti.',
    ]
];